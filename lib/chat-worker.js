...
async function tick() {
    ...
    // Carrinho abandonado: checa a cada ~60s (o tick é de 2s — sem o gate,
    // seria 30 consultas/min à toa numa tabela quase sempre vazia)
    if (typeof chatsApi.processAbandonedCheckouts === 'function'
        && Date.now() - (tick._lastAbandon || 0) > 60000) {
